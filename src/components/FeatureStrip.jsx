  ...
  return (
    <div className="feature-strip">
      ...
      <div className="feature-image-panel">
        <img src={titleCardImg} alt="Now watching" style={{ width: '100%', height: '100%', objectFit: 'cover', position: 'absolute', inset: 0 }} />
      ...
      <div className="feature-text-panel">
        ...
        <div style={{ fontSize: 28, fontWeight: 700, letterSpacing: -1, lineHeight: 1.15 }}>
          Every frame has a Story
        </div>
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,.32)', lineHeight: 1.85 }}>
        ...
        <div
          ...
          style={{ display: 'inline-flex', alignItems: 'center', gap: 8, fontSize: 11, color: GOLD, border: '.5px solid rgba(240,220,130,.3)', padding: '8px 18px', borderRadius: 99, cursor: 'pointer', width: 'fit-content', background: ctaHover ? 'rgba(240,220,130,.08)' : 'transparent', transition: 'all .25s' }}>
          Explore my work →
        </div>
      </div>
