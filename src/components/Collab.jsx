...
export default function Collab() {
  ...
  return (
    <div id="collab" className="collab-container" style={{ textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ fontSize: 'clamp(28px,6vw,68px)', fontWeight: 800, letterSpacing: -2, lineHeight: 1.05, marginBottom: 14 }}>
        Got a project?<br />
