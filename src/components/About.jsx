  ...
  return (
    <section id="about" className="about-grid">
      ...
      <div>
        ...
        <h2 style={{ fontSize: 'clamp(28px,3.5vw,48px)', fontWeight: 700, lineHeight: 1.1, letterSpacing: -2, margin: '0 0 14px 0' }}>
          Hi, I'm <span style={{ color: GOLD }}>Extuse me</span> 👋
        </h2>
        <div style={{ fontSize: 14, color: 'rgba(255,255,255,.68)', lineHeight: 1.9, marginBottom: 20 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        >
          <img src={extuseMeImg} alt="Sarath, Extuse Me film editor and meme creator" loading="lazy" width="1" height="1" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
