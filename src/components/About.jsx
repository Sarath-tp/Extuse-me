  ...
  return (
    <div className="about-grid" style={{ alignItems: 'center' }}>
      ...
      <div>
        ...
        <div style={{ fontSize: 'clamp(28px,3.5vw,48px)', fontWeight: 700, lineHeight: 1.1, letterSpacing: -2, marginBottom: 14 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        >
          <img src={extuseMeImg} alt="Extuse Me" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
